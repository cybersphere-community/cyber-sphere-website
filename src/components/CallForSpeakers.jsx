...
const CallForSpeakers = () => {
    ...
    return (
        <>
        <ScrollReveal className="cyber-card p-8 sm:p-12 transition-all duration-150">
            <div className="flex flex-col md:flex-row gap-12 items-start">
                <div className="flex-1 flex flex-col h-full">
                    <span className="cyber-badge cyber-badge-red mb-6 w-fit">
                        <Mic size={14} className="inline mr-1" /> Call for Speakers
                    </span>
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-6 uppercase font-orbitron">WANT TO DELIVER A <span className="text-red-600">TALK?</span></h2>
                    ...
                    <div className="border border-slate-200 bg-slate-50 p-6">
                        <h4 className="font-bold text-slate-900 mb-3 font-orbitron uppercase text-xs">Why speak at Cyber Sphere?</h4>
                        <ul className="space-y-3">
                            {['Share your knowledge', 'Network with experts', 'Build your personal brand', 'Community recognition'].map((item, i) => (
                                <li key={i} className="flex items-center gap-3 text-slate-600 text-sm">
                                    <div className="w-1.5 h-1.5 bg-red-600 shrink-0"></div>
                                    {item}
                                </li>
                            ))}
                        </ul>
                ...
                <div className="flex-1 w-full">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                <label htmlFor="name" className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wider font-mono-tech">Name</label>
                                <input
                                    type="text"
                                    id="name"
                                    name="name"
                                    ...
                                    className={`w-full bg-slate-50 border ${errors.name ? 'border-red-500' : 'border-slate-200'} text-slate-900 px-4 py-3 focus:outline-none focus:border-red-600 transition-all text-sm font-medium`}
                                    placeholder="Your Name"
                                />
                                {errors.name && <p className="text-red-500 text-xs mt-1 font-bold">{errors.name}</p>}
                            </div>
                            <div>
                                <label htmlFor="email" className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wider font-mono-tech">Email</label>
                                <input
                                    type="email"
                                    id="email"
                                    name="email"
                                    ...
                                    onChange={handleChange}
                                    className={`w-full bg-slate-50 border ${errors.email ? 'border-red-500' : 'border-slate-200'} text-slate-900 px-4 py-3 focus:outline-none focus:border-red-600 transition-all text-sm font-medium`}
                        ...
                        <div className="pb-2">
                            <label htmlFor="phone" className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wider font-mono-tech">Phone Number</label>
                            <div className="flex items-center gap-4">
                                <div className="relative border border-slate-200 bg-slate-50 w-24 shrink-0 focus-within:border-red-600 transition-colors">
                                    <select
                                        name="countryCode"
                                        value={formData.countryCode}
                                        onChange={handleChange}
                                        className="w-full appearance-none bg-transparent text-slate-900 focus:outline-none cursor-pointer font-medium text-sm px-3 py-3"
                                    >
                                        {countryCodes.map(c => (
                                ...
                                <div className="flex-1">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full bg-slate-50 border ${errors.phone ? 'border-red-500' : 'border-slate-200'} text-slate-900 px-4 py-3 focus:outline-none focus:border-red-600 transition-all text-sm font-medium`}
                        ...
                        <div>
                            <label htmlFor="link" className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wider font-mono-tech">Portfolio / LinkedIn</label>
                            <input
                                type="url"
                                id="link"
                                name="link"
                                ...
                                value={formData.link}
                                onChange={handleChange}
                                className={`w-full bg-slate-50 border ${errors.link ? 'border-red-500' : 'border-slate-200'} text-slate-900 px-4 py-3 focus:outline-none focus:border-red-600 transition-all text-sm font-medium`}
                                placeholder="https://linkedin.com/in/..."
                            />
                            {errors.link && <p className="text-red-500 text-xs mt-1 font-bold">{errors.link}</p>}
                        </div>
                        <div>
                            <label htmlFor="topic" className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wider font-mono-tech">Topic Title</label>
                            <input
                                type="text"
                                id="topic"
                                name="topic"
                                ...
                                onChange={handleChange}
                                className={`w-full bg-slate-50 border ${errors.topic ? 'border-red-500' : 'border-slate-200'} text-slate-900 px-4 py-3 focus:outline-none focus:border-red-600 transition-all text-sm font-medium`}
                                placeholder="e.g., Advanced XSS Techniques"
                            />
                            {errors.topic && <p className="text-red-500 text-xs mt-1 font-bold">{errors.topic}</p>}
                        </div>
                        <div>
                            <label htmlFor="abstract" className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wider font-mono-tech">Abstract / Brief</label>
                            <textarea
                                id="abstract"
                                name="abstract"
                                required
                                ...
                                onChange={handleChange}
                                className={`w-full bg-slate-50 border ${errors.abstract ? 'border-red-500' : 'border-slate-200'} text-slate-900 px-4 py-3 focus:outline-none focus:border-red-600 transition-all resize-none text-sm font-medium`}
                            ...
                            <label className="flex items-start gap-3 cursor-pointer group">
                                <div className="flex items-center h-6">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-4 h-4 border-slate-300 text-red-650 focus:ring-red-600 transition-all cursor-pointer"
                                    />
                                </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button 
                                ...
                                className={`flex-1 btn-cyber-primary w-full py-4 text-xs font-bold font-mono-tech flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                            >
                                <span>{isSubmitting ? 'SUBMITTING...' : 'SUBMIT VIA EMAIL'}</span>
                                <Send size={14} className={`transition-transform ${isSubmitting ? 'animate-pulse' : 'group-hover:translate-x-1 group-hover:-translate-y-1'}`} />
                            </button>

                            <button
                                type="button"
                                onClick={handleWhatsApp}
                                className="flex-1 btn-cyber-primary btn-cyber-primary-green w-full py-4 text-xs font-bold font-mono-tech flex items-center justify-center gap-2"
                            >
                                <span>WHATSAPP</span>
        ...
        {showTermsModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                <div className="bg-white border border-slate-200 w-full max-w-2xl max-h-[85vh] flex flex-col shadow-2xl overflow-hidden font-sans">
                    {/* Modal Header */}
                    <div className="flex items-center justify-between p-6 border-b border-slate-100 bg-slate-50/50">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-lg font-bold font-orbitron text-slate-900">Speaker Terms & Conditions – Cyber Sphere</h3>
                        </div>
                        <button 
                    ...
                    <div className="p-6 overflow-y-auto space-y-6 text-slate-650 text-sm leading-relaxed">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Content Usage Permission</h4>
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Educational & Community Use</h4>
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Digital Distribution</h4>
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Platform Monetization & Promotional Usage</h4>
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Professional Conduct</h4>
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Changes & Event Management</h4>
                            ...
                            <div>
                                <h4 className="font-bold text-slate-850 mb-1">Acceptance of Terms</h4>
                    ...
                    <div className="p-6 border-t border-slate-100 bg-slate-50/50 flex items-center justify-end gap-4">
                        <button
                            onClick={() => setShowTermsModal(false)}
                            className="px-6 py-2 border border-slate-350 text-slate-700 font-bold hover:bg-slate-100 transition-colors"
                        >
                            Close
                        </button>
                        <button
                            ...
                            className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white font-bold transition-all flex items-center gap-2"
                        >
                            <Check size={18} />
                            <span>I Agree</span>
                        </button>
