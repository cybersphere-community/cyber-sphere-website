            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    <div className="text-left space-y-8">
                        ...
                        <p className="text-slate-600 text-lg leading-relaxed max-w-lg dark:text-slate-300">
                        ...
                        <div className="flex flex-col space-y-6">
                            <div className="group p-6 bg-white rounded-2xl border border-slate-200 shadow-sm transition-all duration-300 transform dark:bg-white/5 backdrop-blur-md dark:border-white/10">
                                <div className="flex items-center gap-5">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:cybersphere.official@outlook.com" className="text-lg sm:text-xl text-slate-800 font-bold hover:text-brand-primary transition-colors break-all dark:text-slate-100">
                    ...
                    <div className="lg:pl-10">
                        <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
                            {/* Decorative shiny edge */}
                            <div className="absolute inset-0 border border-white/40 rounded-3xl pointer-events-none"></div>

                            <h3 className="text-2xl font-bold text-slate-800 mb-6 dark:text-slate-100">Send a Message</h3>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            id="name"
                                            className="w-full pl-12 pr-4 py-4 bg-white/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-accent/50 focus:border-brand-accent transition-all backdrop-blur-sm"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea
                                            id="message"
                                            rows={4}
                                            className="w-full pl-12 pr-4 py-4 bg-white/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-accent/50 focus:border-brand-accent transition-all backdrop-blur-sm resize-none"
